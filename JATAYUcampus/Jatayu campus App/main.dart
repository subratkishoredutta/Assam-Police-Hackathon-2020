...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Jatayu Campus Protect'),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            //fetches data from DB as Streams and displays it as widgets
            StreamBuilder(
              stream:fire,
              builder: (context, snapshot) {
                ...
                for (var meassage in messages) {
                  final messagecam3 = meassage.data['cam3'];


  
                  final messageWidget = MessageBubble2(cam3: messagecam3,);
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                for (var meassage in messages) {
                  final messagecam1 = meassage.data['cam1'];
                  final messagecam2 = meassage.data['cam2'];


                  final messageWidget = MessageBubble1(cam1: messagecam1,cam2: messagecam2);
                  messageWidgets.add(messageWidget);
                }
                return Row(
                  children: messageWidgets,
